            ...
            <div className="relative">
              ...
              {localState.clickLocation && localState.clickLocation.x > 0 && localState.clickLocation.y > 0 && (
                <div
                  ...
                  style={{
                    left: `${(localState.clickLocation.x / (typeof window !== 'undefined' ? window.innerWidth : 1920)) * 100}%`,
                    top: `${(localState.clickLocation.y / (typeof window !== 'undefined' ? window.innerHeight : 1080)) * 100}%`,
                  }}
                />
              )}
            </div>
